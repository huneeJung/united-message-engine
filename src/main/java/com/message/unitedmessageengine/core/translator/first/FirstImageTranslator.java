...
public class FirstImageTranslator {
    ...
    public byte[] readFileImage(Integer index, ImageVo imageVo) {
        ...
        sb.append("FILENAME").append(index).append(":").append(imageVo.fileName()).append(PROTOCOL_DELIMITER);
        try (var br = new BufferedInputStream(new FileInputStream(imageVo.filePath()))) {
